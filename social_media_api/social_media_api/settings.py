...
# Override with PostgreSQL if DATABASE_URL is set (Heroku or local PostgreSQL)
...
# Alternative: Set USE_POSTGRESQL=True for local PostgreSQL development
...
# tell Django to point to new custom user model.
